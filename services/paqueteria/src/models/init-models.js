...
var _ShipmentTracking = require("./shipment_tracking");
...
function initModels(sequelize) {
  ...
  var ShipmentTracking = _ShipmentTracking(sequelize, DataTypes);
  ...
  ShipmentTracking.belongsTo(Shipment, { as: "shipment", foreignKey: "idShipment" });
  Shipment.hasMany(ShipmentTracking, { as: "trackingEvents", foreignKey: "idShipment" });
